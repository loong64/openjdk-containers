...
# Fake FTP links returned per version for testing
MOCK_FTP_LINKS = {
    8:  ["loongson8.1.26-fx-jdk8u482b08-linux-loongarch64-glibc2.34.tar.gz"],
    11: ["loongson11.17.26-fx-jdk11.0.30_7-linux-loongarch64-glibc2.34.tar.gz"],
    17: ["loongson17.17.26-fx-jdk17.0.18_8-linux-loongarch64-glibc2.34.tar.gz"],
    21: ["loongson21.9.21-fx-jdk21.0.9_10-linux-loongarch64-glibc2.34.tar.gz"],
}


def _mock_fetch_directory_listing(version):
    return MOCK_FTP_LINKS.get(version, [])


class TestLoongnixAPI(unittest.TestCase):

    @patch("loongnix_api._fetch_directory_listing", side_effect=_mock_fetch_directory_listing)
    ...
    def test_get_latest_lts(self, _mock):
        self.assertEqual(get_latest_lts(), 21)
